...
.bc-manual-toggle::-webkit-details-marker { display: none; }
.bc-manual-toggle::before {
  content: '\\203A ';
}
details[open] > .bc-manual-toggle::before {
  content: '\\2304 ';
}
.bc-manual-body {
  margin-top: 8px;
